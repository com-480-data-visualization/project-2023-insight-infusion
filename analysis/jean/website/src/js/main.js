...
const additivesBubbleChart = async (parentWidth) => {
    const data = await d3.json('http://localhost:8081/additives/bubble_chart_additives.json');
    const marginTop = 0;
    const marginRight = 0;
...
const additivesBubbleChart2 = async (parentWidth) => {
    const data = await d3.json('http://localhost:8081/additives/bubble_chart_repartition.json')
...
const additivesFoodCategoryBubbleGraph2 = async (parentWidth) => {
    const data = await d3.json('http://localhost:8081/additives/bubble_chart_categories.json')
...
const vegetarianVeganAdditivesCountBarChart = async () => {
    ...
    const data = await d3.json('http://localhost:8081/additives/vegetarian_vegan_additives_count.json')
...
const vegetarianVeganAverageHazardsBarChart = async () => {
    ...
    const data = await d3.json('http://localhost:8081/additives/vegetarian_vegan_average_hazards.json')
...
const nutriscoreStackedBarChart = async (parentWidth) => {
    const rawData = await d3.json('http://localhost:8081/additives/nutriscore_stacked_bar_chart.json');
...
const novaStackedBarChart = async (parentWidth) => {
    const rawData = await d3.json('http://localhost:8081/additives/nova_stacked_bar_chart.json');
