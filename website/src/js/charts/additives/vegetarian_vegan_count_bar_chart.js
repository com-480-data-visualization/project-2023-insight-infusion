...
/**
 * Bar chart of the number of additives for classic, vegan, vegetarian and 
 * meat products. 
 */
export const vegetarianVeganAdditivesCountBarChart = async () => {
    const data = await json('additives/vegetarian_vegan_additives_count.json')
    ...
    svg.append("g")
        ...
        .call(g => g.append("text")
            ...
            .text("Average number of additives per product →"));
    ...
    const legend = Legend(getLegendScale(d3.extent(data, d => d.average_additives_count), false), {
        title: "Count →",
    })
