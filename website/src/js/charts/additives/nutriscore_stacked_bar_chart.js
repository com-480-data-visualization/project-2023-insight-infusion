 ...
 * hazard of the additives by nutriscore class (nutritional quality). 
 * The total of each bar shows the average number of additives in that 
 * class.
 */
export const nutriscoreStackedBarChart = async (parentWidth) => {
    const rawData = await json('additives/nutriscore_stacked_bar_chart.json')
